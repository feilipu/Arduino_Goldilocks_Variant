...
/** \file
 *  \brief Board specific information header for the Goldilocks.
 *  \copydetails Group_BoardInfo_GOLDILOCKS
 *
 ...
 *  \defgroup Group_BoardInfo_GOLDILOCKS GOLDILOCKS
 *  \brief Board specific information header for the Goldilocks.
 *
 *  Board specific information header for the Goldilocks (http://freetronics.com/goldilocks).
 *
 *  @{
 */

#ifndef __BOARD_GOLDILOCKS_H__
#define __BOARD_GOLDILOCKS_H__
